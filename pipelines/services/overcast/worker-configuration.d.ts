/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8f25202b62b4633a5f63b80c3b4a8e42)
// Runtime types generated with workerd@1.20260721.1 2026-07-24 
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	QUEUE: Queue;
	OVERCAST_EXPORT_URL: "https://overcast.fm/account/export_opml/extended";
	OVERCAST_COOKIE_KEY: string;
	OVERCAST_COOKIE_VALUE: string;
}
